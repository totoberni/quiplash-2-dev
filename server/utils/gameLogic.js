...
class GameLogic {
  ...
  async assignPrompts() {
    ...
    allAnswersReceived() {return (playerManager.getTotalPlayers() === playerManager.answersSubmitted());} // === is strict equality
  ...
  async votesReceived() {
    return playerManager.totalVotes() === playerManager.getnumPlayers() + playerManager.getnumAudience();
  }
